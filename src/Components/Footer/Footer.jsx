        ...
        <footer className="site-footer">
            <div className="footer-content">
                ...
                <div className="logo-column">
                    <a href="">
                    <img className='footer-logo' src="./homepage/pitti-logo.jpg" alt="" />
                    </a>
                </div>
                ...
                <div className="footer-info third-column">
                    ...
                    <a href="https://kalolwala.com" target='_blank'><img className='w-[50px]' src="./homepage/k&a logo.svg" alt="" /></a>
                </div>
            </div>
        </footer>
    );
